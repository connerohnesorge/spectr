...
Documents the Codex CLI provider integration for Spectr, enabling Spectr to work
with OpenAI's Codex CLI through global prompt file management and slash command
generation.
