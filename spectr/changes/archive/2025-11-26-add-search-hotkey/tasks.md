...
- [ ] 1.1 Add `searchMode` bool and `searchQuery` string fields to
...
- [ ] 1.5 Add filtering logic to filter rows by ID and title matching search
  query
...
- [ ] 3.2 Run `spectr validate add-search-hotkey --strict` to verify spec
  validity
