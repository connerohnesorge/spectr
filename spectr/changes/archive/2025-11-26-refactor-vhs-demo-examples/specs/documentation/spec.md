...
directory that VHS tape files use for demonstrations, keeping demos focused on
spectr commands rather than file creation boilerplate.
...
- **AND** the demo output SHALL focus on spectr commands, not `cat` heredocs
  creating files
