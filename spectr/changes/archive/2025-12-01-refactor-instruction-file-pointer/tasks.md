...
- [ ] 1.1 Create `internal/init/templates/spectr/instruction-pointer.md.tmpl` with short pointer content
- [ ] 1.2 Add `RenderInstructionPointer()` method to `TemplateManager` in `templates.go`
