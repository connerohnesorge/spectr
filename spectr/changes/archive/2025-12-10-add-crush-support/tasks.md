...
- [ ] 1.1 Add `PriorityCrush` constant to
  `internal/initialize/providers/constants.go`
- [ ] 1.2 Create `internal/initialize/providers/crush.go` with Crush provider
  implementation
- [ ] 1.3 Verify provider registers correctly with `go build ./...`

## 2. Testing

- [ ] 2.1 Run existing provider tests to ensure no regressions: `go test
