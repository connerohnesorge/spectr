...
type sequences interface {
	...
	commonPrefixLen(
		ai, aj, bi, bj int,
	) int // len(commonPrefix(A[ai:aj], B[bi:bj]))
	commonSuffixLen(
		ai, aj, bi, bj int,
	) int // len(commonSuffix(A[ai:aj], B[bi:bj]))
}
...
func (s stringSeqs) commonPrefixLen(
	ai, aj, bi, bj int,
) int {
	return commonPrefixLenString(
		s.a[ai:aj],
		s.b[bi:bj],
	)
}

func (s stringSeqs) commonSuffixLen(
	ai, aj, bi, bj int,
) int {
	return commonSuffixLenString(
		s.a[ai:aj],
		s.b[bi:bj],
	)
}
...
func (s bytesSeqs) commonPrefixLen(
	ai, aj, bi, bj int,
) int {
	return commonPrefixLenBytes(
		s.a[ai:aj:aj],
		s.b[bi:bj:bj],
	)
}

func (s bytesSeqs) commonSuffixLen(
	ai, aj, bi, bj int,
) int {
	return commonSuffixLenBytes(
		s.a[ai:aj:aj],
		s.b[bi:bj:bj],
	)
}
...
func (s runesSeqs) commonPrefixLen(
	ai, aj, bi, bj int,
) int {
	return commonPrefixLenRunes(
		s.a[ai:aj:aj],
		s.b[bi:bj:bj],
	)
}

func (s runesSeqs) commonSuffixLen(
	ai, aj, bi, bj int,
) int {
	return commonSuffixLenRunes(
		s.a[ai:aj:aj],
		s.b[bi:bj:bj],
	)
}
