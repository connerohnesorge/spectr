...
Add support for Crush AI assistant in Spectr to enable developers to use Crush's
enhanced capabilities for spec-driven development workflows. Crush is a
glamorous CLI AI coding agent from Charmbracelet that supports multiple LLMs,
MCP integration, and session-based work.

## What Changes

- Add Crush provider to the provider registry
  (`internal/initialize/providers/crush.go`)
...
- Provider configures `CRUSH.md` instruction file for the Spectr marker
  injection
