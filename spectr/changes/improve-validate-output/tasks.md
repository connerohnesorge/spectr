...
- [x] 1.1 Add lipgloss styling constants to formatters.go for error/warning colors
- [x] 1.2 Create helper function to convert absolute paths to spectr-relative paths
