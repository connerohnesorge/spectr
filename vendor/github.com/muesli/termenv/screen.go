...
func (o Output) ClearLineRight() {
	fmt.Fprint(
		o.w,
		CSI+EraseLineRightSeq,
	) //nolint:errcheck
}

// ClearLines clears a given number of lines.
func (o Output) ClearLines(n int) {
	clearLine := fmt.Sprintf(
		CSI+EraseLineSeq,
		2,
	) //nolint:mnd
...
func (o Output) ChangeScrollingRegion(
	top, bottom int,
) {
	fmt.Fprintf(
		o.w,
		CSI+ChangeScrollingRegionSeq,
		top,
		bottom,
	) //nolint:errcheck
}
...
func (o Output) EnableMouseExtendedMode() {
	fmt.Fprint(
		o.w,
		CSI+EnableMouseExtendedModeSeq,
	) //nolint:errcheck
}
...
func (o Output) DisableMouseExtendedMode() {
	fmt.Fprint(
		o.w,
		CSI+DisableMouseExtendedModeSeq,
	) //nolint:errcheck
}
