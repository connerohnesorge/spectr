...
- **AND** it SHALL implement `GetProposalCommandPath() string` returning
  relative path for proposal command or empty string
- **AND** it SHALL implement `GetArchiveCommandPath() string` returning relative
  path for archive command or empty string
- **AND** it SHALL implement `GetApplyCommandPath() string` returning relative
  path for apply command or empty string
...
- **THEN** each method SHALL return a relative path including directory and
  filename
