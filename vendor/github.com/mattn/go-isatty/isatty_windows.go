...
var (
	...
	ntdll = syscall.NewLazyDLL(
		"ntdll.dll",
	)
	procGetConsoleMode = kernel32.NewProc(
		"GetConsoleMode",
	)
	procGetFileInformationByHandleEx = kernel32.NewProc(
		"GetFileInformationByHandleEx",
	)
	procGetFileType = kernel32.NewProc(
		"GetFileType",
	)
	procNtQueryObject = ntdll.NewProc(
		"NtQueryObject",
	)
)
