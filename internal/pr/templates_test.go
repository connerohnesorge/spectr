...
// TestRenderPRBody_Proposal tests proposal mode PR body rendering.
func TestRenderPRBody_Proposal(t *testing.T) {
	tests := []struct {
		name     string
		data     PRTemplateData
		expected []string
...
func TestGetPRTitle(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "hyphenated change id - proposal",
			changeID: "my-complex-change-id",
			mode:     ModeProposal,
...
func TestRenderCommitMessage_Remove(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "basic remove",
			data: CommitTemplateData{
				ChangeID: "abandoned-feature",
				Mode:     ModeRemove,
			},
			expected: []string{
				"spectr(remove): abandoned-feature",
				"Removed: spectr/changes/abandoned-feature",
		...
		},
		{
			name: "hyphenated change id",
			data: CommitTemplateData{
				ChangeID: "my-old-change-id",
				Mode:     ModeRemove,
			},
			expected: []string{
				"spectr(remove): my-old-change-id",
				"spectr/changes/my-old-change-id",
			},
		},
	}
...
// TestRenderPRBody_Remove tests remove mode PR body rendering.
func TestRenderPRBody_Remove(t *testing.T) {
	tests := []struct {
		name     string
		data     PRTemplateData
		expected []string
	}{
		{
			name: "basic remove",
			data: PRTemplateData{
				ChangeID: "stale-proposal",
				Mode:     ModeRemove,
			},
			expected: []string{
				"## Summary",
				"`stale-proposal`",
				"**Removed path**: `spectr/changes/stale-proposal/`",
				"## Review Checklist",
