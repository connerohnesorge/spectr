...
func (data *DevInfoListDetailData) SetRemoteMachineName(
...
func (params *DevInstallParams) SetDriverPath(
	driverPath string,
) error {
...
func MakeClassInstallHeader(
	installFunction DI_FUNCTION,
) *ClassInstallHeader {
	hdr := &ClassInstallHeader{
...
func (data *DrvInfoData) SetDescription(
	description string,
) error {
...
func (data *DrvInfoData) SetMfgName(
	mfgName string,
) error {
...
func (data *DrvInfoData) SetProviderName(
	providerName string,
) error {
...
func (data *DrvInfoDetailData) IsCompatible(
	hwid string,
) bool {
...
func SetupDiCreateDeviceInfoListEx(
	...
	if machineName != "" {
		machineNameUTF16, err = UTF16PtrFromString(
			machineName,
		)
		if err != nil {
			return
	...
	return setupDiCreateDeviceInfoListEx(
		classGUID,
		hwndParent,
		machineNameUTF16,
		0,
...
func SetupDiGetDeviceInfoListDetail(
	...
	return data, setupDiGetDeviceInfoListDetail(
		deviceInfoSet,
		data,
	)
}
...
func (deviceInfoSet DevInfo) DeviceInfoListDetail() (*DevInfoListDetailData, error) {
	return SetupDiGetDeviceInfoListDetail(
		deviceInfoSet,
	)
}
...
func SetupDiCreateDeviceInfo(
	...
	deviceNameUTF16, err := UTF16PtrFromString(
		deviceName,
	)
	if err != nil {
		return
	...
	if deviceDescription != "" {
		deviceDescriptionUTF16, err = UTF16PtrFromString(
			deviceDescription,
		)
		if err != nil {
			return
...
func SetupDiEnumDeviceInfo(
	...
	return data, setupDiEnumDeviceInfo(
		deviceInfoSet,
		uint32(memberIndex),
		data,
	)
...
func (deviceInfoSet DevInfo) EnumDeviceInfo(
	memberIndex int,
) (*DevInfoData, error) {
	return SetupDiEnumDeviceInfo(
		deviceInfoSet,
		memberIndex,
	)
}
...
func (deviceInfoSet DevInfo) Close() error {
	return SetupDiDestroyDeviceInfoList(
		deviceInfoSet,
	)
}
...
func (deviceInfoSet DevInfo) BuildDriverInfoList(
	...
	return SetupDiBuildDriverInfoList(
		deviceInfoSet,
		deviceInfoData,
		driverType,
	)
...
func (deviceInfoSet DevInfo) CancelDriverInfoSearch() error {
	return SetupDiCancelDriverInfoSearch(
		deviceInfoSet,
	)
}
...
func SetupDiGetSelectedDriver(
	...
	return data, setupDiGetSelectedDriver(
		deviceInfoSet,
		deviceInfoData,
		data,
	)
...
func (deviceInfoSet DevInfo) SelectedDriver(
	deviceInfoData *DevInfoData,
) (*DrvInfoData, error) {
	return SetupDiGetSelectedDriver(
		deviceInfoSet,
		deviceInfoData,
	)
}
...
func (deviceInfoSet DevInfo) SetSelectedDriver(
	...
	return SetupDiSetSelectedDriver(
		deviceInfoSet,
		deviceInfoData,
		driverInfoData,
	)
...
func (deviceInfoSet DevInfo) DriverInfoDetail(
	...
	return SetupDiGetDriverInfoDetail(
		deviceInfoSet,
		deviceInfoData,
		driverInfoData,
	)
...
func (deviceInfoSet DevInfo) DestroyDriverInfoList(
	...
	return SetupDiDestroyDriverInfoList(
		deviceInfoSet,
		deviceInfoData,
		driverType,
	)
...
func SetupDiGetClassDevsEx(
	...
	if enumerator != "" {
		enumeratorUTF16, err = UTF16PtrFromString(
			enumerator,
		)
		if err != nil {
			return
...
func getRegistryValue(
	...
	case REG_EXPAND_SZ:
		...
		ret := make([]uint16, 100)
		for {
			n, err := ExpandEnvironmentStrings(
				p,
				&ret[0],
				uint32(len(ret)),
			)
	...
	default:
		return nil, fmt.Errorf(
			"Unsupported registry value type: %v",
			dataType,
		)
	}
}
...
func SetupDiGetDeviceInstallParams(
	...
	return params, setupDiGetDeviceInstallParams(
		deviceInfoSet,
		deviceInfoData,
		params,
	)
...
func (deviceInfoSet DevInfo) DeviceInstanceID(
	deviceInfoData *DevInfoData,
) (string, error) {
...
func (deviceInfoSet DevInfo) SetDeviceInstallParams(
	...
	return SetupDiSetDeviceInstallParams(
		deviceInfoSet,
		deviceInfoData,
		deviceInstallParams,
	)
...
func SetupDiClassGuidsFromNameEx(
	className string,
	machineName string,
) ([]GUID, error) {
	classNameUTF16, err := UTF16PtrFromString(
		className,
	)
	if err != nil {
		return nil, err
...
func SetupDiGetSelectedDevice(
	...
	return data, setupDiGetSelectedDevice(
		deviceInfoSet,
		data,
	)
}
...
func (deviceInfoSet DevInfo) SetSelectedDevice(
	deviceInfoData *DevInfoData,
) error {
	return SetupDiSetSelectedDevice(
		deviceInfoSet,
		deviceInfoData,
	)
}
...
func SetupUninstallOEMInf(
	...
	infFileName16, err := UTF16PtrFromString(
		infFileName,
	)
	if err != nil {
		return err
	}
	return setupUninstallOEMInf(
		infFileName16,
		flags,
		0,
	)
...
func CM_Get_Device_Interface_List(
	...
	deviceID16, err := UTF16PtrFromString(
		deviceID,
	)
	if err != nil {
		return nil, err
