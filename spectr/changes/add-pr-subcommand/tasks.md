...
- [x] 1.4 Create `internal/git/worktree.go` with worktree management:
  ...
  - [x] Implement ExecuteInWorktree() - runs command in worktree context
...
- [x] 2.4 Create `internal/pr/workflow.go` with PR workflow:
  ...
  - [x] Implement ExecuteArchivePR() - full archive PR workflow
  - [x] Implement ExecuteNewPR() - full new PR workflow
...
- [x] 3.3 Add shell completion support for change IDs in PR commands
...
- [x] 5.2 Test `spectr pr archive` end-to-end:
  - [x] Test with valid change, verify worktree isolation
...
- [x] 6.1 Add `spectr pr --help` documentation
- [x] 6.2 Add `spectr pr archive --help` documentation
- [x] 6.3 Add `spectr pr new --help` documentation
