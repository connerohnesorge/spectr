...
//
// Providers declare their file initializers as a composable list, and the
// Provider interface is minimal with only 6 methods.
//
...
//	}
//
// Providers implement the interface directly using helper functions.
// No BaseProvider embedding is needed.
package providers
...
//
// The Provider interface is minimal with 6 methods. Providers declare their
// file initializers as a composable list via Initializers().
//
// Configuration is performed using the ConfigureInitializers() helper function,
...
type Provider interface {
	...
	// Each initializer manages a single file (instruction file or slash
	// command).
	//
