...
- **THEN** they SHALL see options to open the page in customized AI chat services
...
The system SHALL configure the starlight-page-actions plugin in the Astro configuration with llms.txt generation disabled and custom AI service list to avoid conflicts with existing starlight-llms-txt plugin while enabling page action functionality.
...
- **AND** the configuration SHALL specify a custom list of AI services for the Open dropdown
