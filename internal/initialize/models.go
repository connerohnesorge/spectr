...
type InitCmd struct {
	...
	PathFlag       string   `                   help:"Alt project path"        name:"path"            short:"p"` //nolint:lll,revive // long struct tags required for CLI framework
	Tools          []string `                   help:"Tools list"              name:"tools"           short:"t"` //nolint:lll,revive // long struct tags required for CLI framework
	NonInteractive bool     `                   help:"Non-interactive"         name:"non-interactive"`           //nolint:lll,revive // long struct tags required for CLI framework
