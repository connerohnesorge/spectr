## 1. Implementation
- [ ] 1.1 Create skill template directory `internal/initialize/templates/skills/spectr-validate-w-spectr-bin/`
- [ ] 1.2 Create `SKILL.md` for the new skill
- [ ] 1.3 Create `scripts/validate.sh` wrapping the spectr binary
